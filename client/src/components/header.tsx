  ...
  return (
    <header className="bg-white border-b border-neutral-100 shadow-sm z-10">
      <div className="flex items-center justify-between px-4 py-3">
        {/* Mobile menu button */}
        <button 
          className="md:hidden rounded-md p-2 text-neutral-400 hover:bg-neutral-50"
          onClick={() => {
        ...
        <div className="flex-1 max-w-2xl mx-4">
          <form onSubmit={handleSearch}>
            <div className="relative">
              ...
              <Input
                type="text"
                className="block w-full pl-10 pr-3 py-2 border border-neutral-200 rounded-lg bg-neutral-50 focus:bg-white"
        ...
        <div className="flex items-center space-x-2">
          ...
          <button className="p-2 rounded-full hover:bg-neutral-50" title="User profile">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
